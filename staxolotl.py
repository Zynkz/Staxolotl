...
def main():
    ...
    sharpened_image = cv2.filter2D(mean_image, -1, kernel)

    save_image(mean_image, "./output/mean_test.fits")
    save_image(sharpened_image, "./output/sharpen_test.fits")

    processed_image = load_image("./output/moon_1753_1.fits")
    # sharpened_image = cv2.filter2D(processed_image, -1, kernel)
    sharpened_image = cv2.Laplacian(processed_image, -1, cv2.CV_16S)
    save_image(sharpened_image, "./output/moon_1753_1_sharp.fits")
